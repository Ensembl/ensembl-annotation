        ...
        foreach my $trans ( @{ $gene->get_all_Transcripts } ) {
          ...
          if ( scalar @exons == scalar @ccds_exons ) {
            ...
            if ( $match == scalar @exons ) {
              ...
              store_ensembl_xref( $outdea, $species, $ccds_trans, $trans->stable_id, $write );
              store_ensembl_xref( $outdea, $species, $ccds_trans->translation, $trans->translation->stable_id, $write );
            }
            else {
